...
<head>
    ...
    <title>KR | Admin - Update Resturent</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="images/avatar/admin.jpeg" alt="user" class="profile-pic" /></a>
