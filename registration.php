                        ...
                        <div class="widget">
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 <div class="row">
								  ...
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder=""> <small class="form-text text-muted"><i>We"ll never share your phone no. with anyone else.</i></small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                       <p> <input type="submit" value="Register" name="submit" class="btn-common btn-white page-scroll"> </p>
                                    </div>
                                 </div>
                              </form>
